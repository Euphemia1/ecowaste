                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul class="mt-4 space-y-4">
                                ...
                                <li><a href="/impact" class="text-base text-gray-300 hover:text-green-400 transition-colors">Impact Tracking</a></li>
                            </ul>
                        </div>
                        <div class="mt-12 md:mt-0">
                            <h3 class="text-sm font-semibold text-gray-300 tracking-wider uppercase">Support</h3>
                            <ul class="mt-4 space-y-4">
                                <li><a href="#" class="text-base text-gray-300 hover:text-green-400 transition-colors">Help Center</a></li>
                                <li><a href="#" class="text-base text-gray-300 hover:text-green-400 transition-colors">Contact Us</a></li>
                                <li><a href="#" class="text-base text-gray-300 hover:text-green-400 transition-colors">Privacy Policy</a></li>
                                <li><a href="#" class="text-base text-gray-300 hover:text-green-400 transition-colors">Terms of Service</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
